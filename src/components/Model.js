...
function Model(state, ...props) {
  ...
  useFrame(() => {
    ...
    if (!isFirstRender) {
      modelRef.current.position.x = storeTarget.pos.x;
      modelRef.current.position.y = storeTarget.pos.y;
      modelRef.current.position.z = storeTarget.pos.z;
      modelRef.current.rotation.x = storeTarget.rot.x;
      modelRef.current.rotation.y = storeTarget.rot.y;
      modelRef.current.rotation.z = storeTarget.rot.z;
